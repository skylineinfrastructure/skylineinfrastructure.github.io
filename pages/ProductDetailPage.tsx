    ...
    <div className="bg-gray-50">
      ...
      <div className="bg-white pt-20 pb-16 border-b border-gray-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <button onClick={() => navigateTo('products')} className="text-sm font-semibold primary-text hover:underline mb-4">
                &larr; Back to Products
            </button>
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900">{product.title}</h1>
      ...
      <div className="bg-white py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-3xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-8 text-center">Benefits of Our Product</h2>
      ...
      <div className="primary-bg">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <h2 className="text-4xl font-extrabold text-white mb-4">Ready to See {product.title} in Action?</h2>
          <p className="max-w-2xl mx-auto mb-8 text-blue-100 text-lg">
            See how {product.title} can transform your business. Schedule a personalized demo with one of our product experts today.
          </p>
